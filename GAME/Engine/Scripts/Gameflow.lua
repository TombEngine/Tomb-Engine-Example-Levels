...
title.horizon = true
title.layer1 = Flow.SkyLayer.new(Color.new(255,192,68),6)
...
karnak.horizon = true
karnak.farView = 80
karnak.fog = Flow.Fog.new(Color.new(255,225,225),20,80)
